...
from pulp import LpInteger, LpMinimize, LpProblem, lpSum, value
...
p = prob.add_variable_matrix("p", (time, unit), 0)
for t in time:
    for i in unit:
...
u = prob.add_variable_matrix("u", (time, unit), 0)
...
s = prob.add_variable_matrix("s", xtime, 0)
